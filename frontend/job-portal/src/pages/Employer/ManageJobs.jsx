...
const ManageJobs = () => {
  ...
  const [sortField, setSortField] = useState("title");   // ADD THIS
  ...
  const filteredAndSortedJobs = useMemo(() => {
    ...
    return filtered;
  }, [jobs, searchTerm, statusFilter, sortDirection, sortField]);
  ...
  //decide whixh sqort icon to display based on current sort field and direction
  ...
  //loading state white animations
  const LoadingRow = () => (
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-4 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-0 transition-all duration-200 bg-gray-50/50 placeholder-gray-400"
                />
              </div>
              {/*status filter */}  
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 overflow-hidden">
              {filteredAndSortedJobs.length === 0 && !isLoading ? (
                ...
                <div className="w-[75vw] md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scroll-track-gray-100">
            ...
            {totalPages >1 && (
              <div className="mt-6 flex items-center justify-between">
                <div className="flex-1 flex justify-between sm:hidden">
                  ...
                  <button
                    onClick={() => 
                      setCurrentPage(Math.mix(totalPages, currentPage + 1))
                    }
