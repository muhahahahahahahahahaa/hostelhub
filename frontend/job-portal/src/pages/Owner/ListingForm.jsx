...
const ListingForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.monthlyRent) nextErrors.monthlyRent = "Monthly rent is required";
    ...
    if (Number(formData.monthlyRent) < 0 || Number(formData.deposit) < 0) {
                ...
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-700">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1">
                        Renters convert better when monthly rent, deposit, free beds,
