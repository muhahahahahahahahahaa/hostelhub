                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                                    {formData.leaseTemplateName && (formData.leaseTemplateUrl || formData.leaseTemplateContent) ? (
                                        <div className="inline-flex items-center gap-2 rounded-lg border border-blue-200 bg-white px-4 py-3 text-sm font-medium text-blue-700">
                                            <FileText className="h-4 w-4" />
                                            <span>{formData.leaseTemplateName}</span>
                                            {formData.leaseTemplateUrl ? <ExternalLink className="h-4 w-4" /> : null}
                                        </div>
                                    ) : (
