            ...
            {canShowInquiryState && (
                <div className="flex flex-col items-end gap-2">
                    <div className="flex flex-wrap items-center justify-end gap-2">
                        {(!listing?.isClosed || Boolean(listing?.inquiryStatus)) && onChat ? (
                            <button
                                type="button"
                                className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-blue-200 bg-white text-blue-700 hover:bg-blue-50 transition-all duration-200"
                                onClick={(e) => {
                                    e.stopPropagation();
                                    onChat();
                                }}
